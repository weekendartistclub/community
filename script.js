/* =========================================================================
   ...
   the #workshop-list container itself and figures out what was clicked.
   This means clicks are always caught correctly no matter when or how
   many times the cards inside it are (re)built — there's no way for a
   button to end up "created after listeners were attached."
...
// -------------------------------------------------------------------------
// EVENT DELEGATION — one click listener for the entire card list.
//
